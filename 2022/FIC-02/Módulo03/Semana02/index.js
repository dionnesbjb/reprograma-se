...
(async () => {
    ...
    const setor_c1 = await Setor.create({
        nome: "Contabilidade", ramal: "2165", email:
            "Contabilidade@empresa.com"
    });
    const setor_D = await Setor.create({
        nome: "Diretoria", ramal: "2100", email:
            "diretoria@empresa.com"
    });
    const setor_R = await Setor.create({
        nome: "Recursos Humanos", ramal: "2168", email:
            "rh@empresa.com"
    });
